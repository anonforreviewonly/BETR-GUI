...
public class ArticulationChainComponent : MonoBehaviour
{
    ...
    {
        if (DriveControllers == null || root == null) DoStart();
    ...
    public class DriveController
    {
        ...
        public void ResetArticulationBody()
        {
            ...
            if (articulationBody.name == "link_5")
            {
                articulationBody.jointPosition = new ArticulationReducedSpace(90f*Mathf.Deg2Rad);
                articulationBody.SetDriveTarget(ArticulationDriveAxis.X, 90);
            }
